...
#base packages
basepkg="linux-firmware linux-firmware-nonfree udisks upower xorg alsa-utils mesa-utils librtmp0 lirc libmad0 lm-sensors libmpeg2-4 avahi-daemon libnfs1 consolekit pm-utils "
